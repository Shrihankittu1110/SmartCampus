...
export default function StudentGradesPage() {
  ...
  const summary = data?.summary || { totalSubjects: 0, totalCredits: 0, cgpa: user?.cgpa || 0 };
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <LoadingSkeleton type="stats-and-table" rows={4} message="Loading Academic Transcript & Grades" />
      ) : (
        <>
          {/* KPI Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <StatCard
              ...
              value={summary.cgpa ? Number(summary.cgpa).toFixed(2) : '0.00'}
              icon={Award}
